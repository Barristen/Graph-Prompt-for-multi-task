...
# file_path = 'UGAD_lyq/datasets-edge/tfinance-els'
# input_dim= 10
# output_dim=2
# dataset_name = 'tfinance-els'    
    ...
    for idx, dataset in enumerate(data_list):
        ...
        if idx == 1:
            if args.prompt_type == 'Gprompt':
                ...
                t1 = time.time()
        if idx == 3 and args.prompt_type == 'Gprompt':
                t2 = time.time()
        print(results)
...
gprompt_time = t0-start
all_in_one_time = t1-t2 + preprocess_time
